 ...
 *
 */
export default class AddBelowTune implements BlockTune {
  /**
  ...
  public render(): HTMLElement {
     ...
     */
    this.api.tooltip.onHover(this.nodes.button, this.api.i18n.t('Add block below'));
  ...
  public handleClick(event: MouseEvent): void {
    ...
    this.api.blocks.insert('paragraph', null, null, this.api.blocks.getCurrentBlockIndex() + 1, true);
